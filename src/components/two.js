    ...
    <div className="flex flex-col lg:flex-row items-center justify-around">
      <div className="w-full lg:w-[58%] p-4 bg-white rounded-lg">
        <div className="flex justify-between items-center mb-4">
          <div className="text-lg lg:text-xl font-bold font-clash-display">
    ...
    <div className="absolute mt-2 left-0 top-10 z-50 w-36 bg-white border border-gray-300 shadow-lg rounded-lg text-sm font-inter">
      <ul className="divide-y divide-gray-200">
        <li
          ...
          aria-selected={selectedOption === "Last 30 Days"}
        >
          Last 30 Days
        </li>
        <li
          ...
          aria-selected={selectedOption === "Last 90 Days"}
        >
          Last 90 Days
        </li>
        <li
          ...
          aria-selected={selectedOption === "Last 365 Days"}
        >
          Last 365 Days
        </li>
      </ul>
      ...
      <div className="w-full lg:w-[40%] p-4 py-5 bg-white rounded-lg">
        <div className="flex justify-between items-center mb-4 pb-3">
          ...
          <div>
            <h2 className="text-[#6200EE]">View All</h2>
          </div>
        </div>
        <RadialBarChart />
      </div>
